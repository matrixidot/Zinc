...
public class Parser(List<Token> tokens) {
    ...
    private Class ClassDeclaration() {
        ...
        Consume(L_BRACE, "Expected '{' before class body.");
        ...
        Consume(R_BRACE, "Expected '}' after class body.");
    ...
    private Break BreakStatement() {
        if (breakCount == 0) {
            throw Error(Previous, "used in invalid place.");
        }
        int line = Peek.line;
        Consume(SEMICOLON, "Expected ';' after 'break' statement.");
        return new Break(new Token(BREAK, "break", null, line));
    }
    ...
    private Continue ContinueStatement() {
        ...
        return new Continue(new Token(CONTINUE, "continue", null, line));
    }
    ...
    private void Synchronize() {
        ...
        while (!IsAtEnd) {
            ...
            switch (Peek.type) {
                case CLASS or FUN or VAR or FOR or IF or WHILE or RETURN: return;
            }
